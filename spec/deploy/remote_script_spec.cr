...
describe Deploy::SSH::RemoteScript, "non-régression" do
  ...
  it "install_crontab est défini et appelé après shards_prepare dans le bloc deploy" do
    ...
    # Marten : utilise la commande CLI intégrée
...
describe Deploy::SSH::RemoteScript, "traduction messages Marten" do
...
describe Deploy::DNS::Ovh, "vérification CNAME" do
