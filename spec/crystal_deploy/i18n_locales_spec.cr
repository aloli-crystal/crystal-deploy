...
describe CrystalDeploy::I18n, "nouvelles locales" do
  before_each do
  ...
  {% for lang, label in {"es" => "espagnol", "de" => "allemand", "pt" => "portugais", "it" => "italien", "nl" => "néerlandais"} %}
    describe {{ lang }} do
      ...
      it "traduit dns.section en {{ lang.id }}" do
        CrystalDeploy::I18n.lang = {{ lang }}
        result = CrystalDeploy::I18n.t("dns.section")
      ...
      it "traduit init.required_empty en {{ lang.id }}" do
        CrystalDeploy::I18n.lang = {{ lang }}
        result = CrystalDeploy::I18n.t("init.required_empty")
      ...
      it "traduit db.sqlite_path_prompt en {{ lang.id }}" do
        CrystalDeploy::I18n.lang = {{ lang }}
        result = CrystalDeploy::I18n.t("db.sqlite_path_prompt")
      ...
      it "traduit dns.key_pat en {{ lang.id }}" do
        CrystalDeploy::I18n.lang = {{ lang }}
        result = CrystalDeploy::I18n.t("dns.key_pat")
