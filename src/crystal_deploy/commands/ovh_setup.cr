  ...
  module Commands
    class OvhSetup
      ...
      private def step2_generate_consumer_key(app_key : String, app_secret : String) : Tuple(String, String)
        ...
        # Déduire la zone DNS depuis le premier environnement disponible
        first_env = @config.environments.values.first?
        dns_zone = first_env ? first_env.dns_zone : "example.app"
